...
- (void)commonInit
{
   ...
   // self.cropView = [[PECropView alloc] initWithFrame:CGRectMake(20, 100, 200, 200)];
    
  //  self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(20, 100, 200, 200)];
    ...
    self.scrollView.backgroundColor = [UIColor colorWithRed:236.0/255.0 green:236.0/255.0 blue:236.0/255.0 alpha:1.0];
    ...
    self.leftOverlayView.backgroundColor = [UIColor clearColor];
    [self addSubview:self.leftOverlayView];
    
    self.rightOverlayView = [[UIView alloc] init];
    self.rightOverlayView.backgroundColor = [UIColor clearColor];
    [self addSubview:self.rightOverlayView];
    
    self.bottomOverlayView = [[UIView alloc] init];
    self.bottomOverlayView.backgroundColor = [UIColor clearColor];
