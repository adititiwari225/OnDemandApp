...
//    APPDELEGATE.kgModelCheck = @"Yes";
//    APPDELEGATE.kgModelYAxix = 80;
    
    
 //   NSLog(@"APPDELEGATE.kgModelYAxix==== %d",APPDELEGATE.kgModelYAxix);
//    
//    if ([APPDELEGATE.kgModelCheck isEqualToString:@"Yes"]) {
//       
//        // for updateing yAxis of POPUP View
//        containerViewRect.origin.y = round(CGRectGetMidY(self.window.bounds)-CGRectGetMidY(containerViewRect)-APPDELEGATE.kgModelYAxix);
//        
//    } else {
//        
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    styleLayer.frame = CGRectInset(self.bounds, 20, 20);
