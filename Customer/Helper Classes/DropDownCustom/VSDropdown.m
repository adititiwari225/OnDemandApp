...
static const CGFloat kDefaultHeight = 200.0;
...
-(void)performSetup
{
    ...
    if ([self.dropDownView isKindOfClass:[UITextField class]])
    {
        UITextField *btn = (UITextField *)self.dropDownView;
        self.font = btn.font;
        self.textColor = btn.textColor;
    }
    else
    {
