...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        [layer setEndPoint:CGPointMake(1.0, 1.5)];
        
        // Create the gradient colors using hues in 5 degree increments
         NSMutableArray *colors = [NSMutableArray array];
        for (NSInteger deg = 0; deg <= 75; deg += 2) {
            UIColor *color;
            UIColor *color1;

            color = [UIColor colorWithHue:2.2 * deg / 270.0
                               saturation:0.5
                               brightness:0.5
                                    alpha:0.5];
        //   color1 = [UIColor colorWithRed:128.0/255.0 green:91.0/255.0  blue:143.0/255.0  alpha:0.8];
        ...
        [maskLayer setFrame:CGRectMake(0, 0.5, 50, 50)];
        [maskLayer setBackgroundColor:[[UIColor purpleColor] CGColor]];
