...
- (void)resizeLayers {
 ...
 //   self.fillClipLayer.backgroundColor = [UIColor redColor].CGColor;
 //   self.patternLayer.backgroundColor = [UIColor colorWithPatternImage:self.patternImage].CGColor;
    
    
    
  //    self.fillClipLayer.backgroundColor = [UIColor yellowColor].CGColor;
  //     self.patternLayer.backgroundColor = [UIColor magentaColor].CGColor;
...
//        _backgroundLayer.colors = @[ (id)[UIColor brownColor].CGColor,
...
//    [super setTintColor:tintColor];
    ...
    [super setTintColor:[UIColor redColor]];
