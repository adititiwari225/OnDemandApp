...
- (void)setDefaultValues
{
    ...
    self.rangeDisplayLabelColor = [UIColor darkGrayColor];
    
    self.segmentSelectedColor = [UIColor whiteColor];
...
- (void)setImageForSegmentOrSliderButton:(UIButton *)button isSlider:(BOOL)isSlider
{
    ...
    {
        [button setBackgroundImage:self.rangeSliderButtonImage forState:UIControlStateNormal];
...
{
//    if (startRange <= 18) {
//        self.minRangeInitialPosition = 18;
//        self.maxRangeInitialPosition = 99;
//    }
//    
//    else{
...
{
//    if (startIndex <= 18) {
//         self.minRangeInitialIndex = 18;
//        self.maxRangeInitialIndex  = 99;
//    }
//    
//    else{
    ...
    if ([self.startSliderButton isSelected])
    {
        if ([self shouldStartButtonSlideForPoint:point])
        {
            [UIView animateWithDuration:0.1 animations:^{
                ...
                [self.startSliderButton setBackgroundColor:[UIColor clearColor]];
...
- (void)callScrollDelegate
{
    ...
    if (self.requireSegments)
    {
        ...
        NSLog(@"Min Index %ld",(long)minIndex);
        NSLog(@"Min Index %ld",(long)maxIndex);
    ...
    else
    {
        ...
        NSLog(@"Min Percent %f",minPercent);
        NSLog(@"Min Percent %f",maxPercent);
