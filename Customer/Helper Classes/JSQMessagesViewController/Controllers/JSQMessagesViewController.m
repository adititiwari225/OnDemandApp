...
- (void)finishSendingMessageAnimated:(BOOL)animated {
    ...
    NSString *messageStr = [textView.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    textView.text = nil;
    ...
    if ([sharedInstance.recipientIdStr length]) {
        
        NSString *urlstr=[NSString stringWithFormat:@"%@?CustomerID=%@&ContractorID=%@&Message=%@&UserType=%@&date=%@",APISendMessage,userIdStr,sharedInstance.recipientIdStr,messageStr,@"1",sharedInstance.dateIdStr];
    ...
    //    NSString *urlstr=[NSString stringWithFormat:@"%@?CustomerID=%@&ContractorID=%@&Message=%@&UserType=%@",APISendMessage,sharedInstance.recipientIdStr,@"Cu00e2618",messageStr,@"2"];
  }
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (sharedInstance.isFromMessageDetails) {
        NSAttributedString *dateTextValue = [collectionView.dataSource collectionView:collectionView attributedTextForCellTopLabelAtIndexPath:indexPath];
        NSString *textDateString = [NSString stringWithFormat:@"%@",dateTextValue];
        NSLog(@"Cell Bottom  DateText %@",textDateString);
        cell.cellTopLabel.text = [textDateString stringByAppendingString:@""];
        cell.messageBubbleTopLabel.attributedText = [collectionView.dataSource collectionView:collectionView attributedTextForMessageBubbleTopLabelAtIndexPath:indexPath];
        NSAttributedString *text = [collectionView.dataSource collectionView:collectionView attributedTextForCellBottomLabelAtIndexPath:indexPath];
        NSLog(@"Cell Bottom Text %@",text);
        NSString *textString = [NSString stringWithFormat:@"%@",text];
        cell.cellBottomLabel.text = [textString stringByAppendingString:@""];
        _isFromMessageDetails = NO;
...
/*
 // Pragma mark Hide CollectionView Header
